...
docker run -d `
    ...
    -v .\04-db-is-shared.sql:/docker-entrypoint-initdb.d/04-db-is-shared.sql `
    -v .\05-db-is-identity.sql:/docker-entrypoint-initdb.d/05-db-is-identity.sql `
    -v .\06-db-is-identity-consent.sql:/docker-entrypoint-initdb.d/06-db-is-identity-consent.sql `
    postgres:latest
